...
if __name__ == "__main__" :
    test = json.load(open('/home/hdasari/Hemanth/MLDS_Data/MLDS_hw2_1_data/testing_label.json','r'))
    output = sys.argv[1]
    result = {}
    ...
    ##>=0.25
    print("Original average bleu score is " + str(average))
    #counting uaing the method mentioned in the paper https://aclanthology.info/pdf/P/P02/P02-1040.pdf
    bleu=[]
    for item in test:
        score_per_video = []
